$(document).ready(function () {
    $('#GridTableContainer').jtable({
        ...
        actions:
        {
            listAction: '/AgentDashboard/GetAllAgentTickets'
        },
    ...
    $("#Username").autocomplete({
        source: function (request, response) {
            $.ajax({
                url: "/AgentDashboard/GetAllAgentUsers",
                type: "GET",
                dataType: "json",
...
$.getJSON(url,
    function (data) {
        if (data) {
            ...
            $.each(data,
                function (index, optionData) {
                    $("#DropPriority").append("<option text='" +
                        optionData.Text +
                        "' value='" +
                        optionData.Value +
                        "'>" +
                        optionData.Text +
                        "</option>");
                    $("#DropChangePriority").append("<option text='" +
                        optionData.Text +
                        "' value='" +
                        optionData.Value +
                        "'>" +
