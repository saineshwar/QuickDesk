    ...
    $("#PriorityId").change(function ()
    {
        if (confirm("Are you sure you want to change Priority this?")) {
            if ($("#PriorityId").val() != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "../TicketDetailsAgentsAdmin/ChangePriority",
                    dataType: "json",
        ...
        if (confirm("Are you sure you want to change Status this?")) {
            if ($("#StatusId").val() != "") {
                ...
                if ($("#StatusId").val() == '8' || $("#StatusId").val() == '9') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../TicketDetailsAgentsAdmin/ChangeStatus",
                        dataType: "json",
                        data: JSON.stringify(jsonObject),
                        contentType: "application/json; charset=utf-8",
                        success: function(data, textStatus, xhr) {
    ...
    $("#CategoryId").change(function ()
    {
        if (confirm("Are you sure you want to change Category this?")) {
            if ($("#CategoryId").val() != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "../TicketDetailsAgentsAdmin/ChangeCategory",
                    dataType: "json",
                    data: JSON.stringify(jsonObject),
                    contentType: "application/json; charset=utf-8",
                    success: function(data, textStatus, xhr) {
...
function deleteTicketReply(ticketId, ticketReplyId)
{
    ...
    if (result === true) {
        if (ticketId != "" && ticketReplyId != "")
        {
            ...
            $.ajax({
                type: "POST",
                url: "../TicketDetailsAgentsAdmin/Delete",
                dataType: "json",
                data: JSON.stringify(jsonObject),
                contentType: "application/json; charset=utf-8",
                success: function (data, textStatus, xhr)
