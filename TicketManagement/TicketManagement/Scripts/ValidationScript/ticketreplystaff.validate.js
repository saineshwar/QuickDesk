    ...
    $("#PriorityId").change(function ()
    {
        if (confirm("Are you sure you want to change Priority this?"))
        {
            if ($("#PriorityId").val() != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "../TicketDetailsAgent/ChangePriority",
                    dataType: "json",
        ...
        if (confirm("Are you sure you want to change Status this?")) {
            if ($("#StatusId").val() != "") {
                ...
                if ($("#StatusId").val() == '8' || $("#StatusId").val() == '9') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../TicketDetailsAgent/ChangeStatus",
                        dataType: "json",
                        data: JSON.stringify(jsonObject),
                        contentType: "application/json; charset=utf-8",
                        success: function(data, textStatus, xhr) {
    ...
    $("#CategoryId").change(function ()
    {
        if (confirm("Are you sure you want to change Category this?")) {
            if ($("#CategoryId").val() != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "../TicketDetailsAgent/ChangeCategory",
                    dataType: "json",
                    data: JSON.stringify(jsonObject),
                    contentType: "application/json; charset=utf-8",
                    success: function(data, textStatus, xhr) {
...
function restoreTicketReply(ticketId, ticketReplyId) 
{
    var result = confirm("Do you want to restore ticket reply!");
    if (result === true) {
        if (ticketId != "" && ticketReplyId != "") {
            var jsonObject =
            {
            ...
            $.ajax({
                type: "POST",
                url: "../TicketDetailsAgent/DeleteRestore",
                dataType: "json",
                data: JSON.stringify(jsonObject),
                contentType: "application/json; charset=utf-8",
                success: function (data, textStatus, xhr) {
...
function SendEmail(trackingId)
{
    ...
    if (result === true) {
        if (trackingId != "")
        {
            ...
            $.ajax({
                type: "POST",
                url: "../SendNotificationAgent/Notification",
                dataType: "json",
                data: JSON.stringify(jsonObject),
                contentType: "application/json; charset=utf-8",
                success: function (data, textStatus, xhr) {
